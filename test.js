...
function(){
    ...
    function aq(){
        ...
        if(g.isCountdown){
            C="countdown="+intToStrTwo(g.hours)+":"+intToStrTwo(g.minutes)+":"+intToStrTwo(g.seconds);if(g.enabled){
                C+="&date="+getFormattedLocalDT(g.alarmTime,true,false)
            }
            else{
                C+="&enabled=0";C+="&seconds="+g.value
            }
